...
brew install --cask android-platform-studio docker github gpg-suite microsoft-auto-update microsoft-edge mullvadvpn raspberry-pi-imager visual-studio-code