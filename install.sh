...
brew install --cask brave-browser docker element google-drive github ivpn lens onlyoffice raspberry-pi-imager visual-studio-code yubico-yubikey-manager wireshark
